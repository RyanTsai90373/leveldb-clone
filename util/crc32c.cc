// Minimal byte-by-byte CRC32C implementation.
// Polynomial: 0x1EDC6F41 (Castagnoli), reflected form.
// Ported from LevelDB's util/crc32c.cc (stripped of hardware
// acceleration and slicing-by-N optimizations).
